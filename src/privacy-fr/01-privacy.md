...
- **Comptes d'édition.** Chaque instance tient une liste des personnes autorisées à ajouter du contenu. Pour chaque personne qui édite, elle conserve un nom, une adresse e-mail, des pronoms facultatifs et des horodatages de connexion, tant que le compte est actif. Un compte peut aussi détenir une empreinte (hash) de mot de passe, mais le mot de passe est facultatif : à la place, une personne qui édite peut se connecter par un lien à usage unique qui lui est envoyé par e-mail à chaque fois, auquel cas aucun mot de passe n'est conservé. Voir *Tes informations et ce que tu peux demander en tant que personne qui édite* plus bas.
- **Inscription autonome (seulement si qui opère l'active).** Certaines personnes qui opèrent ouvrent leur instance à l'inscription autonome des personnes qui éditent. Quand c'est activé, n'importe qui peut demander un compte d'édition en indiquant un nom et une adresse e-mail ; l'e-mail est confirmé par un lien à usage unique avant que le compte puisse servir. Une demande jamais confirmée est supprimée automatiquement après une courte période. L'inscription autonome est désactivée à moins que qui opère ne décide de l'activer ; sur la plupart des instances, les comptes d'édition sont encore créés par qui opère.
...
Si tu as un compte d'édition sur une instance, que qui opère l'ait créé pour toi ou que tu te sois inscrit toi-même, ce qui suit s'applique à toi.

- **Pourquoi nous gardons tes données : parce que tu as accepté.** Avant de pouvoir utiliser l'éditeur, on te demande de vérifier ces documents et de les accepter : à ta première connexion si qui opère a créé ton compte, ou au moment de l'inscription si tu t'es joint toi-même. Ton acceptation est enregistrée avec la version de chaque document, de sorte qu'une révision ultérieure te la redemande. Tu peux retirer ton consentement à tout moment.
- **Ce qui est conservé à ton sujet :** ton nom, ton adresse e-mail, les pronoms que tu indiques, des horodatages de connexion, le contenu éditorial que tu publies et un journal d'audit des actions administratives que tu réalises (dans lequel ton e-mail n'est conservé que sous forme d'empreinte salée, jamais en clair). Si tu utilises un mot de passe, son empreinte est conservée ; si tu te connectes plutôt par des liens envoyés par e-mail, aucun mot de passe n'est conservé. Les jetons de connexion à usage unique et de courte durée (pour les liens par e-mail qui te connectent, confirment une inscription ou te permettent de définir un mot de passe) ne sont conservés que sous forme d'empreintes, et seulement jusqu'à leur usage ou leur expiration.

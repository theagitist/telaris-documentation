...
Voici la version courte. Cinq étapes, quatre pages, et tu auras publié ton premier trou de ver. Pour tout ce qui dépasse les bases (portails, toile de mots-clés, visites, vues multigalaxies, dépannage, le pourquoi et le pourquoi-pas des choix éditoriaux), le **Manuel d'édition** complet est disponible à :

<https://www.telaris.ca/docs/editor-manual-fr.pdf>
...
Une galaxie est le contenant dans lequel vivront tes trous de ver. Chaque trou de ver appartient à une seule galaxie.

<div class="page-break"></div>

## Étape 3 : Crée un trou de ver

Sélectionne **Nouveau trou de ver** (à côté du compteur de trous de ver). Un formulaire s'ouvre :

![Fenêtre Nouveau trou de ver](assets/images/editor-manual-fr/05-new-wormhole-modal.png)

Remplis trois champs, dans l'ordre. Laisse le reste pour plus tard.

1. **Nom**. Comme s'appelle ce trou de ver. Qui visite verra cette étiquette dans la scène 3D. Obligatoire.
2. **Description**. Le texte que qui visite lit en ouvrant le trou de ver. Écris dans ta propre voix ; le formatage markdown de base fonctionne.
3. **Mots-clés**. Tape un mot-clé et appuie sur **Entrée** (ou virgule) pour l'ajouter comme étiquette. Deux ou trois suffisent. Les mots-clés sont la manière dont ce trou de ver se connecte à d'autres ; un trou de ver étiqueté *côte* se connecte à tous les autres trous de ver étiquetés *côte*, à la fois dans cette galaxie et dans le reste de l'instance.
...
> [!tip] Quand quelque chose ne va pas
> Si une page ne se charge pas, si un bouton ne répond pas, ou si un message apparaît que tu ne comprends pas, c'est le moment d'écrire à qui exploite ton instance. Cette personne tient le système allumé. Tout dans ce Démarrage rapide suppose que l'instance fonctionne comme prévu.

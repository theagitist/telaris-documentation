...
1. Abre **New Wormhole** desde el inicio del editor (o abre el modal de edición de un agujero de gusano existente y cambia su tipo).
2. Fija **Wormhole type** a **Portal**. Aparece un campo **Target Galaxy** con un desplegable que lista cada galaxia a la que tienes acceso.
3. Elige la galaxia de destino del desplegable. El botón junto a él, **Create New Galaxy**, es un atajo para el caso en que el destino aún no existe; seleccionarlo te permite hacer autoría del destino en línea. La mayoría del tiempo, eliges una galaxia existente.
...
5. Añade una **Description** si quieres un párrafo corto que aparezca cuando la visitante abra la ficha del portal. La descripción se muestra brevemente antes de que comience el viaje a la galaxia de destino; trátala como una oración umbral.
...
El portal aparece ahora en la lista de agujeros de gusano con una etiqueta **Portal** en la columna Type, y como un nodo distinguible en la escena 3D.
...
- La ficha muestra el nombre del portal, la descripción, y (dependiendo de los ajustes de la instancia) un botón de llamada a la acción llamado **Travel** o algo similar.
...
- **Un portal puede ser retargeteado** editándolo y eligiendo una galaxia distinta en el campo Target Galaxy. Las visitantes que habían marcado el portal seguirán aterrizando en la galaxia que ahora esté seleccionada. Considera esto al cambiar destinos después de publicar.

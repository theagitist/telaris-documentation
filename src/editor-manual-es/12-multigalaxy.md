...
- **La visitante en una vista de unión no puede saber a primera vista qué galaxia escribió un agujero de gusano dado** más allá del tema visual del icono del agujero de gusano. La ficha muestra la galaxia de origen al pie; el tema del icono es el indicador a un vistazo.

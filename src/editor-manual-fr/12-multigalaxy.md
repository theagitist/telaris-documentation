...
- **Dans une vue d'union, la galaxie source est signalée à plusieurs endroits.** Quand plus d'une galaxie est en vue, le nom de la galaxie du trou de ver apparaît en préfixe devant le nom du trou de ver dans la fenêtre de média 3D, l'infobulle au survol, et la carte 2D, pour que deux trous de ver aux noms identiques venant de galaxies différentes restent distinguables au premier coup d'œil. Le thème de l'icône du trou de ver est un indice instantané supplémentaire, et la fiche d'information nomme la galaxie source dans son pied.
...
- **Qui exploite ton instance peut assouplir la correspondance des mots-clés.** Par défaut, deux trous de ver ne se connectent que lorsqu'ils portent le *même* mot-clé. Qui exploite peut activer la correspondance floue pour l'instance ou pour un amas, de sorte que des orthographes proches (un pluriel, une petite faute de frappe) tracent aussi une ligne de relation entre galaxies. Si tu vois des connexions entre des mots qui sont proches mais pas identiques, c'est ce réglage qui l'explique ; il se contrôle côté administration, pas par trou de ver.
